        ...
        >
            <Grid item>
                <Typography
                    ...
                    gutterBottom
                >
                    Which service are you intrested in?
                </Typography>
            </Grid>
            <Grid item container>
                <Grid item container direction={"column"} md>
                    ...
                    <Grid item>
                        <img src={software} alt={"Three floating screen"} className={classes.icon}/>
                    </Grid>
                </Grid>
                <Grid item container direction={"column"} md>
                    <Grid item style={{maxWidth: "12em"}}>
                    ...
                    <Grid item>
                        <img src={mobile} alt={"Mobile outline"} className={classes.icon}/>
                    </Grid>
                </Grid>
                <Grid item container direction={"column"} md>
                    <Grid item style={{maxWidth: "12em"}}>
                    ...
                    <Grid item>
                        <img src={website} alt={"Desktop outline"} className={classes.icon}/>
                    </Grid>
                </Grid>
            </Grid>
            <Grid
